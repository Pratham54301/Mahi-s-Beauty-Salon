        ...
        <div className="container max-w-2xl">
            <Card className="shadow-lg">
                <CardContent className="p-8">
                    ...
                    <p className="text-muted-foreground text-center mb-8">Enter your order details to see its status.</p>
                    <Form {...form}>
                    <form
                ...
                <Card className="mt-12 shadow-lg">
                    <CardContent className="p-8">
                        ...
                        <div className="relative flex justify-between items-start">
                            ...
                            <div className="absolute top-1/2 left-0 h-1 bg-primary -translate-y-1/2 -z-10" style={{ width: `${(trackingResult.currentStep / (timelineSteps.length - 1)) * 100}%` }}/>
                             {timelineSteps.map((step, index) => (
                                <div key={step.name} className="flex flex-col items-center gap-2 text-center z-0">
                                    <div className={cn( "h-10 w-10 rounded-full flex items-center justify-center", index <= trackingResult.currentStep ? "bg-primary text-primary-foreground" : "bg-muted text-muted-foreground" )}>
                                        {step.icon}
                                    </div>
